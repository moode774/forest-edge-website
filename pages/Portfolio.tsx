...
export const Portfolio: React.FC = () => {
   ...
   useEffect(() => {
    ...
    const projects = [
       { id: 1, title: "Royal Suite Renovation", titleAr: "ترميم الجناح الملكي", loc: "Riyadh", locAr: "الرياض", img: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=2000&q=90", type: ar ? "سكني" : "RESIDENTIAL", span: "col-span-1 md:col-span-12", aspect: "aspect-[4/3] md:aspect-[16/7.5]", rounded: "rounded-[2rem] md:rounded-[2.5rem]" },
